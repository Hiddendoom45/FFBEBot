...
public enum Banner {
	...
	//gacha 2.0 change
	Olive("Olive Banner",new Unit[]{Unit.Olive,Unit.Shine,Unit.Shera},new int[]{50,570,1205},Lib.concat(new Unit[]{Unit.Emperor,Unit.Leon,Unit.Guy},FFII.pool),FFII.include,BannerType.BaseRare),
