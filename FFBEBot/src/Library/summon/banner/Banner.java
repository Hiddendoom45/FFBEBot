...
public enum Banner {
	...
	Christmas1rerun("2016 Christmas rerun",new Unit[]{Unit.WKN,Unit.SRoselia,Unit.Gilbert},BannerRates.EvenSplit.fiveRate(),Christmas2.pool,Christmas2.include,BannerType.ThreePercent),
	KingKnight("King's Knight",new Unit[]{Unit.RayJack,Unit.Kaliva,Unit.Barusa,Unit.Toby},BannerRates.D4.fiveRate(),Christmas1rerun.pool,Christmas1rerun.include,BannerType.ThreePercent),
