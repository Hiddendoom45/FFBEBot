...
public enum Banner {
	...
	XenoSalt("Xeogears",new Unit[]{Unit.Fei,Unit.Elly,Unit.Bart},BannerRates.LT5.featuredFive(),new Unit[]{Unit.Salt3,Unit.Salt4},Yuraisha.include,BannerType.ThreePercentFeatured),
